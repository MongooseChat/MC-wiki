...
.. tab-set::
    ...
    .. tab-item:: Linux
        ...
        From steam there will be two options when launching the game. Project Zomboid does have a native linux build and steam also allows for compatibility mode.
